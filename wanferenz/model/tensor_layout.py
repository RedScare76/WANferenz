...
def run_command(hf_ckpt_path, save_path, n_experts, mp, expert_dtype):
            ...
            for name in f.keys():
                ...
                for i in range(mp):
                    ...
                    if "experts" in name and "shared_experts" not in name:
                        ...
                        wanferenz_size = param.size(dim) // mp
                        new_param = param.narrow(
                            dim, i * wanferenz_size, wanferenz_size
                        ).contiguous()
        ...
        for name in names:
            if name.endswith("wo_a.weight"):
                ...
                if expert_dtype == "fp8":
                    ...
                    state_dicts[i][name], state_dicts[i][scale_name] = (
